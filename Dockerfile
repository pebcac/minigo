...
# Set git variables
#RUN sudo echo "git config --global http.sslVerify false" >> /etc/bashrc
#RUN sudo echo "git config --global user.name 'Preston Davis'" >> /etc/bashrc
#RUN sudo echo "git config --global user.email 'pdavis@pebcac.org'" >> /etc/bashrc
#RUN sudo echo "git config --global user.name 'Preston Davis'" >> /etc/zshrc
#RUN sudo echo "git config --global user.email 'pdavis@pebcac.org'" >> /etc/zshrc
